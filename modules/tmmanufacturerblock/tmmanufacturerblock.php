...
class TmManufacturerBlock extends Module
{
	...
	public function install()
	{
		...
		Configuration::updateValue('TM_MANUFACTURER_DISPLAY_IMAGE_TYPE', 'medium_default');
	...
	public function hookDisplayHome()
	{
		...
		if (Configuration::get('TM_MANUFACTURER_DISPLAY_CAROUCEL'))
		{
			...
			$this->context->controller->addJS($this->_path.'js/tmmanufacturerblock.js');
		}
	...
	{
		$this->context->controller->addCSS($this->_path.'css/tmmanufacturerblock.css', 'all');
	}
	...
	{
		return array(
			'TM_MANUFACTURER_DISPLAY_NAME' => Tools::getValue('TM_MANUFACTURER_DISPLAY_NAME', Configuration::get('TM_MANUFACTURER_DISPLAY_NAME')),
			'TM_MANUFACTURER_DISPLAY_IMAGE' => Tools::getValue('TM_MANUFACTURER_DISPLAY_IMAGE', Configuration::get('TM_MANUFACTURER_DISPLAY_IMAGE')),
			'TM_MANUFACTURER_DISPLAY_IMAGE_TYPE' => Tools::getValue('TM_MANUFACTURER_DISPLAY_IMAGE_TYPE', Configuration::get('TM_MANUFACTURER_DISPLAY_IMAGE_TYPE')),
			'TM_MANUFACTURER_DISPLAY_ITEM_NB' => Tools::getValue('TM_MANUFACTURER_DISPLAY_ITEM_NB', Configuration::get('TM_MANUFACTURER_DISPLAY_ITEM_NB')),
			'TM_MANUFACTURER_DISPLAY_CAROUCEL' => Tools::getValue('TM_MANUFACTURER_DISPLAY_CAROUCEL', Configuration::get('TM_MANUFACTURER_DISPLAY_CAROUCEL')),
			'TM_MANUFACTURER_CAROUCEL_NB' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_NB', Configuration::get('TM_MANUFACTURER_CAROUCEL_NB')),
			'TM_MANUFACTURER_CAROUCEL_SLIDE_WIDTH' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_SLIDE_WIDTH', Configuration::get('TM_MANUFACTURER_CAROUCEL_SLIDE_WIDTH')),
			'TM_MANUFACTURER_CAROUCEL_SLIDE_MARGIN' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_SLIDE_MARGIN', Configuration::get('TM_MANUFACTURER_CAROUCEL_SLIDE_MARGIN')),
			'TM_MANUFACTURER_CAROUCEL_AUTO' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_AUTO', Configuration::get('TM_MANUFACTURER_CAROUCEL_AUTO')),
			'TM_MANUFACTURER_CAROUCEL_ITEM_SCROLL' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_ITEM_SCROLL', Configuration::get('TM_MANUFACTURER_CAROUCEL_ITEM_SCROLL')),
			'TM_MANUFACTURER_CAROUCEL_SPEED' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_SPEED', Configuration::get('TM_MANUFACTURER_CAROUCEL_SPEED')),
			'TM_MANUFACTURER_CAROUCEL_AUTO_PAUSE' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_AUTO_PAUSE', Configuration::get('TM_MANUFACTURER_CAROUCEL_AUTO_PAUSE')),
			'TM_MANUFACTURER_CAROUCEL_RANDOM' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_RANDOM', Configuration::get('TM_MANUFACTURER_CAROUCEL_RANDOM')),
			'TM_MANUFACTURER_CAROUCEL_LOOP' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_LOOP', Configuration::get('TM_MANUFACTURER_CAROUCEL_LOOP')),
			'TM_MANUFACTURER_CAROUCEL_HIDE_CONTROL' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_HIDE_CONTROL', Configuration::get('TM_MANUFACTURER_CAROUCEL_HIDE_CONTROL')),
			'TM_MANUFACTURER_CAROUCEL_PAGER' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_PAGER', Configuration::get('TM_MANUFACTURER_CAROUCEL_PAGER')),
			'TM_MANUFACTURER_CAROUCEL_CONTROL' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_CONTROL', Configuration::get('TM_MANUFACTURER_CAROUCEL_CONTROL')),
			'TM_MANUFACTURER_CAROUCEL_AUTO_CONTROL' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_AUTO_CONTROL', Configuration::get('TM_MANUFACTURER_CAROUCEL_AUTO_CONTROL')),
			'TM_MANUFACTURER_CAROUCEL_AUTO_HOVER' => Tools::getValue('TM_MANUFACTURER_CAROUCEL_AUTO_HOVER', Configuration::get('TM_MANUFACTURER_CAROUCEL_AUTO_HOVER')),
		);
	}
