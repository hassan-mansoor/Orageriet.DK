                        ...
                        <div class="product-image-container">
                            ...
                            <div class="saleNew">
                                {if isset($product.new) && $product.new == 1}
                                    <a class="new-box" href="{$product.link|escape:'html':'UTF-8'}">{l s='New'}</a>
                                {/if}
                                {if isset($product.on_sale) && $product.on_sale && isset($product.show_price) && $product.show_price && !$PS_CATALOG_MODE}
                                    <a class="sale-box" href="{$product.link|escape:'html':'UTF-8'}">{l s='Sale!'}</a>
                                {/if}
                            </div>    
                        </div>
                    ...
                    <div class="right-block">
                        <h5 itemprop="name">
                            ...
                            <a class="product-name" href="{$product.link|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}" itemprop="url" >
                                ...
                                <span class="grid-name">{$product.name|truncate:40:'...'|escape:'html':'UTF-8'}</span>
                            </a>
                        </h5>
                        ...
                        <div class="functional-buttons clearfix">
                            ...
                            {if isset($comparator_max_item) && $comparator_max_item}
                                ...
                                <div class="moreCustom">
                                    <a itemprop="url" class="moreLink {if (isset($product.customization_required) && $product.customization_required)}customize{/if}" href="{$product.link|escape:'html':'UTF-8'}" title="{l s='View'}">
