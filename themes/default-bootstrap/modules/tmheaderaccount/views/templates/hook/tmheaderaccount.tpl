<div id="header-login">
    <div class="current header_user_info {if $is_logged}logged{/if}"><a href="#" onclick="return false;">{if $is_logged}{l s='Your Account' mod='tmheaderaccount'}{else}{l s='Sign in' mod='tmheaderaccount'}{/if}</a></div>
