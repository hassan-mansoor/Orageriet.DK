                    ...
                    {if $slide.active}
                        <li class="homeslider-container">
                            ...
                            {if isset($slide.description) && trim($slide.description) != ''}
                                <div class="homeslider-description"><a class="descLink" href="{$slide.url|escape:'html':'UTF-8'}" title="{$slide.legend|escape:'html':'UTF-8'}"><div class="container"><div class="descInner">{$slide.description}</div></div></a></div>
                            {/if}
                        </li>
                    {/if}
                {/foreach}
